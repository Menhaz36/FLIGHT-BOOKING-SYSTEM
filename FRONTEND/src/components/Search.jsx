            ...
            <div className='flex flex-col'>
                <div className="flex flex-wrap gap-6 md:gap-10 max-md:gap-4 justify-center w-full ">
                    ...
                    <div>
                        ...
                        <input id="from" type="text" placeholder="Source" value={source} onChange={(e) => setSource(e.target.value)} className="w-full rounded border border-gray-300 px-4 py-3 mt-1 text-base outline-none focus: border-b-cyan-700" required />
                    </div>
                    ...
                    <div>
                        ...
                        <input id="to" type="text" placeholder="Destination" value={destination} onChange={(e) => setDestination(e.target.value)} className="w-full rounded border border-gray-300 px-4 py-3 mt-1 text-base outline-none focus: border-b-cyan-700" required />
                    </div>
